...
SHOPIFY_REDIRECT_URI = os.getenv(
    ...
    "https://ledger-shopify.onrender.com/api/v1/auth/callback",
)


@router.get("")
async def shopify_auth_gateway(
    shop: str = Query(..., description="Target Shopify store domain handle"),
):
    ...
    auth_url = (
        ...
        f"?client_id={SHOPIFY_API_KEY}&scope={scopes}&redirect_uri={SHOPIFY_REDIRECT_URI}"
    )
